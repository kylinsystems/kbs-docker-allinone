...
$JAVA ${DEBUG} $IDEMPIERE_JAVA_OPTIONS $VMOPTS -DIDEMPIERE_HOME=$BASE -DPropertyFile=$BASE/idempiere.properties -jar $BASE/plugins/org.eclipse.equinox.launcher_1.*.jar -application org.adempiere.server.application
